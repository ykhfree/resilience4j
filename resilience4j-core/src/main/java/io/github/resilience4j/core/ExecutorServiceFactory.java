...
public final class ExecutorServiceFactory {
    ...
    private static final String VIRTUAL_OPTION   = "virtual";
    ...
    /**
     * Returns {@code true} when the user prefers virtual threads.
     */
    public static boolean useVirtualThreads() {
        ...
        return VIRTUAL_OPTION.equalsIgnoreCase(value);
    }
    ...
    private static ThreadFactory newPlatformThreadFactory(String poolName) {
        return runnable -> {
            Thread t = new Thread(runnable,
                "%s-%d".formatted(poolName, POOL_ID.incrementAndGet()));
            t.setDaemon(true);
            return t;
        };
    }
