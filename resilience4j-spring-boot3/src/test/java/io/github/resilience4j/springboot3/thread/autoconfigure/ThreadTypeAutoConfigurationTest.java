...
public class ThreadTypeAutoConfigurationTest {
    ...
    public void testThreadTypePropertyIsSetToSystemProperty() {
        try {
            ...
            assertThat(properties.getType()).isEqualTo("virtual");
            ...
            assertThat(systemProperty).isEqualTo("virtual");
            
            // Verify that ExecutorServiceFactory correctly recognizes the virtual thread configuration
            boolean usingVirtualThreads = ExecutorServiceFactory.useVirtualThreads();
            assertThat(usingVirtualThreads).isTrue();
        } finally {
    ...
    public void testThreadTypeAutoConfigurationRegistered() {
        try {
            ...
            assertThat(System.getProperty("resilience4j.thread.type")).isEqualTo("virtual");
        } finally {
            // Clean up after test
            System.clearProperty("resilience4j.thread.type");
        }
